...
<body>
  ...
  <div class="container-fluid">
    <div class="container">
      ...
      createHeader('book', 'Báo Cáo Nhập Hàng', 'Báo Cáo Nhập Hàng');
      ?>
      <!-- header section end -->
      ...
      <div class="row">
        ...
        <div class="col-md-12 form-group form-inline">
          <label class="font-weight-bold" for="">Bắt Đầu :&emsp;</label>
          <input type="date" class="form-control" id="start_date" onchange="showReport('purchase');">
          &emsp;
          <label class="font-weight-bold" for="">Kết Thúc :&emsp;</label>
