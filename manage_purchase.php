...
<body>
  ...
  <div class="container-fluid">
    <div class="container">
      ...
      createHeader('bar-chart', 'Quản Lý Nhập Hàng', 'Quản Lý Nhập Hàng');
      ?>
      <!-- header section end -->
      ...
      <div class="row">
        <div class="col-md-12 form-group form-inline">
          ...
          <input type="number" class="form-control" id="by_voucher_number" placeholder="Mã Giảm Giá" onkeyup="searchPurchase(this.value, 'VOUCHER_NUMBER');">
          &emsp;<input type="text" class="form-control" id="by_suppliers_name" placeholder="Tên Nhà Cung Cấp" onkeyup="searchPurchase(this.value, 'SUPPLIER_NAME');">
          &emsp;<input type="number" class="form-control" id="by_invoice_number" placeholder="Hóa Đơn" onkeyup="searchPurchase(this.value, 'INVOICE_NUMBER');">
          &emsp;<label class="font-weight-bold" for="">Ngày Nhập :&emsp;</label>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  <th style="width: 1%;">#</th>
                  <th style="width: 12%;">Số Mã Giảm Giá</th>
                  <th style="width: 18%;">Tên Nhà Cung Cấp</th>
                  <th style="width: 12%;">Mã Hóa Đơn</th>
                  <th style="width: 15%;">Ngày Nhập Hàng</th>
