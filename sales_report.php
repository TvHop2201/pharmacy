...
<body>
  ...
  <div class="container-fluid">
    <div class="container">
      ...
      createHeader('book', 'Báo Cáo Bán Hàng', 'Báo Cáo');
      ?>
      <!-- header section end -->
      ...
      <div class="row">
        ...
        <div class="col-md-12 form-group form-inline">
          <label class="font-weight-bold" for="">Ngày Bắt Đầu :&emsp;</label>
          <input type="date" class="form-control" id="start_date" onchange="showReport('sales');">
          &emsp;
          <label class="font-weight-bold" for="">Ngày Kết Thúc :&emsp;</label>
