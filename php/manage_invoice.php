...
?>
  <tr>
    ...
    <td><?php echo $row['NET_TOTAL']; ?> vnd</td>
    <td>
...
?>
  ...
  <div class="row">
    ...
    <div class="col-md-10 h3" style="color: #ff5252;">Hóa Đơn Của Khách Hàng<span class="float-right">Mã Hóa Đơn : <?php echo $invoice_number; ?></span></div>
  </div>
  <div class="row font-weight-bold">
    <div class="col-md-1"></div>
    <div class="col-md-10"><span class="h4 float-right">Thời Gian : <?php echo $invoice_date; ?></span></div>
  </div>
  ...
  <div class="row">
    <div class="col-md-1"></div>
    <div class="col-md-4">
      <span class="h4">Chi Tiết Khách Hàng : </span><br><br>
      <span class="font-weight-bold">Tên : </span><?php echo $customer_name; ?><br>
      <span class="font-weight-bold">Địa Chỉ : </span><?php echo $address; ?><br>
      <span class="font-weight-bold">Số Điện Thoại : </span><?php echo $contact_number; ?><br>
      <span class="font-weight-bold">Tên Bác Sỹ : </span><?php echo $doctor_name; ?><br>
      <span class="font-weight-bold">Địa Chỉ Bác Sỹ : </span><?php echo $doctor_address; ?><br>
    </div>
