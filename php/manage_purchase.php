...
?>
  <tr>
    ...
    <td><?php echo $row['VOUCHER_NUMBER'] ?></td>
    <td>
      <input id="suppliers_name" type="text" class="form-control" value="<?php echo $row['SUPPLIER_NAME']; ?>" placeholder="Tên Nhà Cung Câp" name="suppliers_name" onkeyup="showSuggestions(this.value, 'supplier');" disabled>
