...
?>
  <tr>
    ...
    <td><?php echo $row['MRP']; ?> vnd</td>
    <td><?php echo $row['RATE']; ?> vnd</td>
    <td>
...
?>
  <tr>
    ...
    <td><?php echo $row['GENERIC_NAME']; ?></td>
    <td>
      <input type="text" class="form-control" value="<?php echo $row['BATCH_ID']; ?>" placeholder="Mã Lô Hàng" id="batch_id" onblur="notNull(this.value, 'batch_id_error');">
      <code class="text-danger small font-weight-bold float-right" id="batch_id_error" style="display: none;"></code>
    </td>
    <td>
      <input type="text" class="form-control" value="<?php echo $row['EXPIRY_DATE']; ?>" placeholder="Hết hạn" id="expiry_date" onblur="checkExpiry(this.value, 'expiry_date_error');">
      <code class="text-danger small font-weight-bold float-right" id="expiry_date_error" style="display: none;"></code>
    </td>
    <td><?php echo $row['SUPPLIER_NAME']; ?></td>
    <td>
      <input type="number" class="form-control" value="<?php echo $row['QUANTITY']; ?>" placeholder="Số Lượng" id="quantity" onkeyup="checkQuantity(this.value, 'quantity_error');">
      <code class="text-danger small font-weight-bold float-right" id="quantity_error" style="display: none;"></code>
    </td>
    <td>
      <input type="number" class="form-control" value="<?php echo $row['MRP']; ?>" placeholder="giá" id="mrp" onkeyup="checkValue(this.value, 'mrp_error');">
      <code class="text-danger small font-weight-bold float-right" id="mrp_error" style="display: none;"></code>
    </td>
    <td>
      <input type="number" class="form-control" value="<?php echo $row['RATE']; ?>" placeholder="giá nhập" id="rate" onkeyup="checkValue(this.value, 'rate_error');">
