...
function addNewPurchase()
{
  ...
  if ($con) {
    ...
    $result = mysqli_query($con, $query);
    if ($result)
      echo "Giao dịch mua đã được lưu ...";
    else
      echo "Thất bại";
  }
}
...
?>
  <div class="row col col-md-12">
    <div class="col col-md-2">
      <input type="text" class="form-control" placeholder="Tên Thuốc" name="medicine_name">
  ...
  <div class="row col col-md-8">
    <div class="col col-md-4"><label for="generic_name" class="font-weight-bold">&nbsp;Tên Chung : </label></div>
