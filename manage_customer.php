...
<body style="max-height: 100%;">
  ...
  <div class="container-fluid">
    <div class="container">
      ...
      createHeader('handshake', 'Quản Lý Khách Hàng', 'Quản Lý Khách Hàng');
      ?>
      <!-- header section end -->
      ...
      <div class="row">
        ...
        <div class="col-md-12 form-group form-inline">
          ...
          <input type="text" class="form-control" id="" placeholder="Tìm Kiếm Khách Hàng" onkeyup="searchCustomer(this.value);">
        </div>
            ...
            <table class="table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th style="width: 13%;">Tên Bác Sỹ</th>
                  <th style="width: 17%;">Địa Chỉ Bác Sỹ</th>
